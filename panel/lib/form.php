...
class form {
  ...
  function buttons($active) {
    ...
    $available = array(
      ...
      'blockquote' => '<a href="#blockquote" rel="tag" data-tag-open="'.PHP_EOL.'    ">' . l::get('form.buttons.blockquote') . '</a>',
      'code'       => '<a href="#code" rel="tag" data-tag-open="`" data-tag-close="`">' . l::get('form.buttons.code') . '</a>',
      'hr'         => '<a href="#hr" rel="tag" data-tag-open="'.PHP_EOL.'****">' . l::get('form.buttons.hr') . '</a>',
      'ul'         => '<a href="#ul" rel="tag" data-tag-open="'.PHP_EOL.'- ">' . l::get('form.buttons.ul') . '</a>',
      'ol'         => '<a href="#ol" rel="tag" data-tag-open="'.PHP_EOL.'1. ">' . l::get('form.buttons.ol') . '</a>',
